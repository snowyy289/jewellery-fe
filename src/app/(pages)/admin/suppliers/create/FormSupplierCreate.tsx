...
import { Truck, Activity, Save, X, User, Phone, Mail, MapPin, FileText, Building } from "lucide-react";
...
export default function FormSupplierCreate() {
    ...
    return (
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
                <AdminCard title="Thông tin cơ bản" subTitle="Chi tiết về nhà cung cấp">
