                        ...
                        <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3 p-1 bg-slate-100/50 rounded-2xl border border-slate-200/50">
                                <label className="cursor-pointer">
                                    <input type="radio" name="status" value="active" defaultChecked={brand?.status === 'active'} className="sr-only peer" />
                                ...
                                <label className="cursor-pointer">
                                    <input type="radio" name="status" value="inactive" defaultChecked={brand?.status === 'inactive'} className="sr-only peer" />
