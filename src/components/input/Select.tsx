    ...
    return (
        <div className="flex flex-col gap-1.5 w-full text-left">
            ...
            <div className="relative group">
                {/* Left icon */}
                {icon && (
                    <div className="absolute left-2.5 top-1/2 -translate-y-1/2 pointer-events-none transition-colors duration-200 text-slate-400 group-focus-within:text-indigo-500 z-10 flex items-center justify-center">
                        {icon}
                    </div>
                )}
                ...
                <select
                    ...
                    className={`
                        ...
                        shadow-sm cursor-pointer tracking-tighter
                        ${icon ? "pl-8" : "px-4"}
                        ${
                            error
